...
Widget nakoAppButton(BuildContext context, String title, Function onTap) {
  return AppButton(
    width: MediaQuery.of(context).size.width,
    color: kTeal400,
    shapeBorder: const RoundedRectangleBorder(borderRadius: BorderRadius.all(Radius.circular(5))),
    onTap: onTap,
